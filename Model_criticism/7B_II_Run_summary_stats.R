...
betaX = 0.1 #0.2 #0.1 #0.2 #0.05 #0.025 #0.2 #0.1 
gammaX = 10 #5 #10 #5 #10 #8 #TRY WITH SMALLER GAMMA
...
inference_type = 'ss_events_infer_sum_statsII/'
...
#PLOT
plot_p_vals(df_p_valuesBI, model_type)
