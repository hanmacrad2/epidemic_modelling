...
mcmc_ss_investigate_r0_total <- function(data, n, sigma, alphaX, betaX, gammaX, param_infer, true_R0, x0 = 1) { #burn_in = 2500
...
betaX = 0.2 #0.2 #0.05 #0.2 #0.05 #0.05
gammaX = 10
param_infer = 'alpha'   #!!!!!!!!!!!
true_param_val = alphaX #!!!!!!!!!!!
